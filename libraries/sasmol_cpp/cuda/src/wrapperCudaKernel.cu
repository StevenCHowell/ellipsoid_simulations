...
void
sascalc::cuda::
wrapper_cudaMC_setupGrid(const TYPE * const gpu_coor, const TYPE * const gpu_radii, int * const gpu_grid, const int Natoms,
...
void
sascalc::cuda::
wrapper_cudaMC_fill(const TYPE * const gpu_coor, const TYPE * const gpu_radii, const int * const gpu_grid, TYPE * const gpu_points,
...
void
sascalc::cuda::
wrapper_cudaGV_calcIq(const TYPE * const gpu_coor, const TYPE * const gpu_b, const TYPE * const gpu_gv, const TYPE * const gpu_q, TYPE * const gpu_Is, const int Natoms, const int Nq, const int Ngv)
{
	// set the CUDA block dimenstions
...
void
sascalc::cuda::
wrapper_cudaGV_calcIq_subset(const TYPE * const gpu_coor, const TYPE * const gpu_b, const TYPE * const gpu_gv, const TYPE * const gpu_q, TYPE * const gpu_Is, const int Natoms, const int Natoms_subset, const int Nq, const int Ngv, const TYPE scale)
{
	// set the CUDA block dimenstions
    dim3 dim_grid(Ngv), dim_block(Nq);
	// cudakernel launch configuration
...
void
sascalc::cuda::
wrapper_cudaGV_calcIq_GVVV(const TYPE * const gpu_coor, const TYPE * const gpu_radius, const TYPE * const gpu_gv, const TYPE * const gpu_q, TYPE * const gpu_Is, const int Natoms, const int Nq, const int Ngv, const TYPE sld_solvent)
{
	// set the CUDA block dimenstions
    dim3 dim_grid(Ngv), dim_block(Nq);
	// cudakernel launch configuration
...
void
sascalc::cuda::
wrapper_cudaGV_calcIq_GVGaussian(const TYPE * const gpu_coor, const TYPE * const gpu_radius, const TYPE * const gpu_gv, const TYPE * const gpu_q, TYPE * const gpu_Is, const int Natoms, const TYPE volume, const int Nq, const int Ngv, const TYPE sld_solvent)
{
	// set the CUDA block dimenstions
    dim3 dim_grid(Ngv), dim_block(Nq);
	// cudakernel launch configuration
...
void
sascalc::cuda::
wrapper_cudaGV_calcIq_Merge_ND(const TYPE * const gpu_coor, const TYPE * const gpu_b, const TYPE * const gpu_radius, const TYPE * const gpu_mc_coor, const TYPE * const gpu_gv, const TYPE * const gpu_q, TYPE * const gpu_Is, const int Natoms, const int N_mc_points, const TYPE volume, const int Nq, const int Ngv, const TYPE sld_solvent)
{
	// set the CUDA block dimenstions
    dim3 dim_grid(Ngv), dim_block(Nq);
	// cudakernel launch configuration
...
void
sascalc::cuda::
wrapper_cudaGV_calcIq_Merge_GVVV(const TYPE * const gpu_coor, const TYPE * const gpu_b, const TYPE * const gpu_radius, const TYPE * const gpu_gv, const TYPE * const gpu_q, TYPE * const gpu_Is, const int Natoms, const int Nq, const int Ngv, const TYPE sld_solvent, const TYPE scale_volume)
{
	// set the CUDA block dimenstions
    dim3 dim_grid(Ngv), dim_block(Nq);
	// cudakernel launch configuration
	...
	// launch the kernel
	sascalc::cuda::cudaKernel_GV_calc_Merge_GVVV<<<dim_grid, dim_block>>>(gpu_coor, gpu_b, gpu_radius, gpu_gv, gpu_q, gpu_Is, Natoms, Nq, Ngv, sld_solvent, scale_volume);
	CALL_CUDA(cudaGetLastError());
}
...
void
sascalc::cuda::
wrapper_cudaGV_calcIq_Merge_GVGaussian(const TYPE * const gpu_coor, const TYPE * const gpu_b, const TYPE * const gpu_radius, const TYPE * const gpu_gv, const TYPE * const gpu_q, TYPE * const gpu_Is, const int Natoms, const TYPE volume, const int Nq, const int Ngv, const TYPE sld_solvent)
{
	// set the CUDA block dimenstions
    dim3 dim_grid(Ngv), dim_block(Nq);
	// cudakernel launch configuration
...
void
sascalc::cuda::
wrapper_cudaGV_calcIq_Merge_NDsubset(const TYPE * const gpu_coor, const TYPE * const gpu_b, const TYPE * const gpu_radius, const TYPE * const gpu_mc_coor, const TYPE * const gpu_gv, const TYPE * const gpu_q, TYPE * const gpu_Is, const int Natoms, const int N_mc_points, const int N_mc_points_subset, const TYPE volume, const int Nq, const int Ngv, const TYPE sld_solvent)
{
	// set the CUDA block dimenstions
    dim3 dim_grid(Ngv), dim_block(Nq);
	// cudakernel launch configuration
...
void
sascalc::cuda::
wrapper_cudaDebye_calcIq(const TYPE * const gpu_coor, const TYPE * const gpu_b, const TYPE * const gpu_q, TYPE * const gpu_Ia, const int Natoms, const int Nq)
{
	// set the CUDA block dimenstions
    dim3 dim_grid((Natoms-1)/BLOCKDIM+1), dim_block(BLOCKDIM);
	// cudakernel launch configuration
...
void
sascalc::cuda::
wrapper_cudaDebye_calcIq_subset(const TYPE * const gpu_coor, const TYPE * const gpu_b, const TYPE * const gpu_q, TYPE * const gpu_Ia, const int Natoms, const int Natoms_subset, const int Nq, const TYPE scale)
{
	// set the CUDA block dimenstions
...
void
sascalc::cuda::
wrapper_cudaDebye_calcIq_CustomizedModel(const TYPE * const gpu_coor, const TYPE * const gpu_b, const TYPE * const gpu_radius, const TYPE * const gpu_q, TYPE * const gpu_Ia, const int Natoms, const int Nq)
{
	// set the CUDA block dimenstions
    dim3 dim_grid((Natoms-1)/BLOCKDIM+1), dim_block(BLOCKDIM);
	// cudakernel launch configuration
