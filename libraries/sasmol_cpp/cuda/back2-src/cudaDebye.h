    ...
    public sascalc::Debye
{
    ...
    public:
        ...
        virtual void calcIq_subset(const float * const gpu_coor, const float * const gpu_b, const int Natoms_subset, const float scale=1.0);
        virtual void calcIq_CustomizedModel(const float * const gpu_coor, const float * const gpu_b, const float * const gpu_radius);
