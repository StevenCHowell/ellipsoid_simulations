...
namespace sascalc
{
    namespace cuda
    {
        ...
        __global__ void cudaKernel_GV_calc_Merge_GVVV(const float * const gpu_coor, const float * const gpu_b, const float * const gpu_radius, const float * const gpu_gv, const float * const gpu_q, float * const gpu_I, const int Natoms, const int Nq, const int Ngv, const float sld_solvent);
