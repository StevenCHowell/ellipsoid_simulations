...
void
sascalc::cudaGV::
calcIq_Merge_GVVV(const float * const gpu_coor, const float * const gpu_b, const float * const gpu_radius, const int Natoms, const float sld_solvent)
{
    sascalc::cuda::wrapper_cudaGV_calcIq_Merge_GVVV(gpu_coor, gpu_b, gpu_radius, _gpu_gv, _gpu_q, _gpu_Is, Natoms, _Nq, _Ngv, sld_solvent);
    _harvest();
}
