    ...
    public sascalc::GV
{
    ...
    public:
        ...
        virtual void calcIq_Merge_GVVV(const float * const gpu_coor, const float * const gpu_b, const float * const gpu_radius, const int Natoms, const float sld_solvent=-0.005618666666666664, const float scale_volume=0.7);
