...
namespace sassubset 
{
    ...
    class Mask: public sasmol::SasAtomBase
    {
        ...
        public:
            ...
            void set_coor_using_mask(Eigen::Matrix<float,3,Eigen::Dynamic> & coor, const size_t frame, const boost::dynamic_bitset<> & mask); ///< (Brief description)
            void set_sasmolcoor_using_mask(sasmol::SasMol & mol_mask, const size_t frame, const boost::dynamic_bitset<> & mask); ///< (Brief description)
            ...
            void duplicate_molecule(sasmol::SasMol & mol, const int frame, const int n, const float d, const bool flag_seperate_resid=true, const bool flag_rotate=false);
