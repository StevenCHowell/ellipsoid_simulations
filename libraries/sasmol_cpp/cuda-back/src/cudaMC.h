    ...
    public sascalc::MC
{
    ...
    protected:
        ...
        void _harvest();
    public:
        void fill(const float * const gpu_coor, const float * const gpu_radii, const int Natoms, const float x0, const float y0, const float z0, const float xl, const float yl, const float zl);
