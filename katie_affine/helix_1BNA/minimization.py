...
from shapes import sphere_equation as shape_equation
...
def calcX2(parameters, Nq, qmax, Q,Iq_exp, Iq_model, Err_exp, bs, coordinate_matrix):
    ...
    affine.fillShapeByReverseAffineTransformation(Npoints, affine_transformation_matrix, shape_equation, coordinate_matrix)
...
if __name__ == '__main__':
    ...
    # run minimization 
    Npoints = 10000
    parameters = (70.0, 0.0, 0.0,  0.0,40.0,0.0, 0.0,0.0,40.0)
