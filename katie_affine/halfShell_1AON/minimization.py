...
from affine.shapes import halfShell_equation as shape_equation
...
def calcX2(parameters, Nq, qmax, Q,Iq_exp, Iq_model, Err_exp, bs, coordinate_matrix):
    ...
    if sx<=0.0 or sy<=0.0 or sz<=0.0 or ri<=0.0 or ri>=1.0:
        return numpy.inf
...
if __name__ == '__main__':
    ...
    # run minimization 
    Npoints = 10000
    parameters = (60,60,90, 0.5, 0,0,0, 0,0,0)
